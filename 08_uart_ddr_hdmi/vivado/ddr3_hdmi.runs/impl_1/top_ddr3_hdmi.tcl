...
set rc [catch {
  ...
  add_files -quiet E:/Exercise/FPGA/v3edu/08_uart_ddr_hdmi/vivado/ddr3_hdmi.runs/synth_1/top_ddr3_hdmi.dcp
  ...
  link_design -top top_ddr3_hdmi -part xc7a75tfgg484-2
