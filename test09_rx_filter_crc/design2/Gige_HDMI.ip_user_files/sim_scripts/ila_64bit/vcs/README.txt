...
#
# Generated by export_simulation on Mon Feb 10 10:04:26 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './ila_64bit.sh' script.

./ila_64bit.sh -reset_run
...
./ila_64bit.sh -noclean_files

For more information on the script, please type './ila_64bit.sh -help'.
