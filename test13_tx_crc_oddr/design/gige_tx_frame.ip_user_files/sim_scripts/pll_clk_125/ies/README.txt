...
#
# Generated by export_simulation on Wed Feb 12 15:13:34 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './pll_clk_125.sh' script.

./pll_clk_125.sh -reset_run
...
./pll_clk_125.sh -noclean_files

For more information on the script, please type './pll_clk_125.sh -help'.
