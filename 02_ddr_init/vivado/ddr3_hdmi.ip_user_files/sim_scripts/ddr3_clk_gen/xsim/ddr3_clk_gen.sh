...
#
# Generated by Vivado on Tue Oct 29 14:33:36 +0800 2019
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ddr3_clk_gen xil_defaultlib.ddr3_clk_gen xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ddr3_clk_gen -key {Behavioral:sim_1:Functional:ddr3_clk_gen} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ddr3_clk_gen.wdb xsim.dir)
