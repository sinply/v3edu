...
#
# Generated by export_simulation on Wed Feb 12 16:45:12 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './blk_wr8x4096.sh' script.

./blk_wr8x4096.sh -reset_run
...
./blk_wr8x4096.sh -noclean_files

For more information on the script, please type './blk_wr8x4096.sh -help'.
