...
#
# Generated by export_simulation on Sun Feb 09 19:16:54 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './asfifo_wr16x64.sh' script.

./asfifo_wr16x64.sh -reset_run
...
./asfifo_wr16x64.sh -noclean_files

For more information on the script, please type './asfifo_wr16x64.sh -help'.
