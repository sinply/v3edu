...
#
# Generated by export_simulation on Sun Feb 09 17:29:49 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './asfifo_wr8x8192.sh' script.

./asfifo_wr8x8192.sh -reset_run
...
./asfifo_wr8x8192.sh -noclean_files

For more information on the script, please type './asfifo_wr8x8192.sh -help'.
