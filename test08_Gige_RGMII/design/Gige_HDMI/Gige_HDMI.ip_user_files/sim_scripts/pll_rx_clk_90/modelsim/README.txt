...
#
# Generated by export_simulation on Sat Feb 08 14:53:27 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './pll_rx_clk_90.sh' script.

./pll_rx_clk_90.sh -reset_run
...
./pll_rx_clk_90.sh -noclean_files

For more information on the script, please type './pll_rx_clk_90.sh -help'.
