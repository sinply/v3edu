...
#
# Generated by export_simulation on Sat Feb 08 15:05:55 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './ila_32bit.sh' script.

./ila_32bit.sh -reset_run
...
./ila_32bit.sh -noclean_files

For more information on the script, please type './ila_32bit.sh -help'.
